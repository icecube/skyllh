...
class SignalTimePDFTestCase(
    ...
    def setUp(self):
        ...
        self.time_flux_profile = BoxTimeFluxProfile(t0=5, tw=10)
    ...
    def test__calculate_sum_of_ontime_time_flux_profile_integrals(self):
        S = (
            self.sig_time_pdf._calculate_sum_of_ontime_time_flux_profile_integrals()
        )
    ...
    def test_get_pd(self):
        ...
        (pd, grads) = self.sig_time_pdf.get_pd(
            tdm=tdm, params_recarray=src_params_recarray
        )
