...
class SpatialBoxAndPsiFuncEventSelectionMethod_TestCase(unittest.TestCase):
    ...
    def test_select_events_single_source(self):
        ...
        ) = evt_sel_method_sb.select_events(self.test_events, retidxs=True)
