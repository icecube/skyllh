...
exp_data_test = np.array(
    ...
    dtype=exp_data_test_dtype)

mc_data_test = np.array(
    ...
    dtype=mc_data_test_dtype)

grl_data_test = np.array(
    ...
    dtype=grl_data_test_dtype)

np.save('exp_data.npy', exp_data_test)
np.save('mc_data.npy', mc_data_test)
np.save('GRL/grl_data.npy', grl_data_test)

livetime_data_test = np.array([[58443.0, 58443.25],
                               [58443.5, 58443.75],
                               [58444.0, 58444.25], 
                               [58444.5, 58444.75]])

np.save('livetime_data.npy', livetime_data_test)