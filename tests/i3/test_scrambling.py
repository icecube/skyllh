...
class I3TimeScramblingMethodTestCase(unittest.TestCase):
    ...
    def test_scramble(self):
        ...
        data = i3timescramblingmethod.scramble(rss=rss, dataset=None, data=exp_data)  # pyright: ignore[reportArgumentType]
