...
def create_analysis(
        ...
        ppbar=None,
        logger_name=None,
        test_new_EnergySignalPDF = False
):
    ...
    logger_name : str | None
        ...
        be used.
    test_new_EnergySignalPDF:
        For test porpuses, to check if for one source both versions for the energy 
        PDF give the same results
    Returns
    -------
    ...
    for (ds_idx, ds) in enumerate(datasets):
        ...
        if test_new_EnergySignalPDF:
            ...
            print('New Version is being used')
        else:
            ...
            print('Old Version is being used')
