...
@overload
def float_cast(v: float | str | bool, errmsg: str, allow_None: Literal[False] = ...) -> float: ...
@overload
def float_cast(v: float | str | bool | None, errmsg: str, allow_None: Literal[True]) -> float | None: ...
