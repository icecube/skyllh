...
def create_dataset_collection(base_path=None, sub_path_fmt=None):
    ...
    IC40.add_aux_data_definition("mceq_flux_datafile", "fluxes/mceq_IC40.pkl")
    IC40.add_aux_data_definition(
    ...
    IC59.add_aux_data_definition("mceq_flux_datafile", "fluxes/mceq_IC59.pkl")
    IC59.add_aux_data_definition(
    ...
    IC79.add_aux_data_definition("mceq_flux_datafile", "fluxes/mceq_IC79.pkl")
    IC79.add_aux_data_definition(
