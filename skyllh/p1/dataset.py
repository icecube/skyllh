...
class P1Dataset(
    ...
    """The P1Dataset class is an IceCube specific Dataset class that adds
    ...
    def get_combined_grl_pathfilenames(datasets):
        ...
        Parameters
        ----------
        datasets : sequence of P1Dataset
            The sequence of P1Dataset instances.
        ...
        """
        if not issequenceof(datasets, P1Dataset):
            raise TypeError(
                'The datasets argument must be a sequence of P1Dataset '
                'instances!')
    ...
    def __str__(self):
        """Implementation of the pretty string representation of the P1Dataset
        object.
        """
        s = super().__str__()
        s += '\n'
...
class P1DatasetData(
    ...
    def __init__(
        ...
        """Constructs a new P1DatasetData instance.
