...
The source time PDF, $T_{\mathrm{S}}(t|\vec{p}_{\mathrm{s},\mathrm{time}})$, describes the emission time profile
...
the source position $\xs$ consists of three quantities: right-ascension,
...
\code{\_\_call\_\_(src\_pos src\_params)}, which takes the celestial position
