...
approximated by a second-order Taylor expension for events with $\alpha_i < \alpha$:
\begin{equation}
...
\end{equation}
For the numerical unstable case, where $\alpha_i < \alpha$, this derivative is
...
and unstable ($\alpha_i < \alpha$) case.
