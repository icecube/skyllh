...
As source hypothesis a point-like source with factorized time-dependence of the
spatial and energy profiles could be assumed. The particle flux of
equation (\ref{eq:PhiS-general}) for such a point-like source could be
formulated as:
\begin{equation}
...
$\epsilon(E|\ps)$ the energy-profile of the source flux, and
$T_{\mathrm{S}}(t|\ps)$ the time-profile of the source flux for given source
parameters, $\ps$.

The energy-dependence of the source flux, i.e. the emission energy-profile of
the source, might be assumed to be a power-law:
\begin{equation}
