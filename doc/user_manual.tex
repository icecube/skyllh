...
\end{equation}
\begin{equation}
 \frac{\partial \mathcal{R}_i(\ps)}{\partial p_{\mathrm{s,energy}}} = \mathcal{R}_{S,i}(\vec{p}_{s,\mathrm{spatial}}) \frac{\partial \mathcal{R}_{\mathcal{E},i}(\vec{p}_{s,\mathrm{energy}})}{\partial p_{\mathrm{s,energy}}} \mathcal{R}_{\mathcal{T},i}(\vec{p}_{s,\mathrm{time}}),
\end{equation}
\begin{equation}
 \frac{\partial \mathcal{R}_i(\ps)}{\partial p_{\mathrm{s,time}}} = \mathcal{R}_{S,i}(\vec{p}_{s,\mathrm{spatial}}) \mathcal{R}_{\mathcal{E},i}(\vec{p}_{s,\mathrm{energy}}) \frac{\partial \mathcal{R}_{\mathcal{T},i}(\vec{p}_{s,\mathrm{time}})}{\partial p_{\mathrm{s,time}}}.
\end{equation}
...
\begin{equation}
 \frac{\partial \mathcal{R}_{i}(\ps)}{\partial p_{\mathrm{s}}} = - \frac{1}{A^2} \frac{\partial A}{\partial p_{\mathrm{s}}} \sum_{k=1}^{K} a_{k} \mathcal{R}_i(\psk) + \frac{1}{A}\sum_{k=1}^{K} \left( \frac{\partial a_{k}}{\partial p_{\mathrm{s}}}\mathcal{R}_i(\psk) + a_{k}\frac{\partial \mathcal{R}_i(\psk)}{\partial p_{\mathrm{s}}} \right).
\end{equation}
Using $\mathcal{R}_i(\ps)$ from equation (\ref{eq:RiStacking}) it simplifies to
\begin{equation}
 \frac{\partial \mathcal{R}_{i}(\ps)}{\partial p_{\mathrm{s}}} = \frac{1}{A(\ps)}\left[ -\mathcal{R}_i(\ps)\frac{\partial A}{\partial p_{\mathrm{s}}} + \sum_{k=1}^{K} \left( \frac{\partial a_{k}}{\partial p_{\mathrm{s}}}\mathcal{R}_i(\psk) + a_{k}\frac{\partial \mathcal{R}_i(\psk)}{\partial p_{\mathrm{s}}} \right) \right],
 \label{eq:gradRi}
\end{equation}
with the derivative of $A(\ps)$ given by
\begin{equation}
 \frac{\partial A}{\partial p_{\mathrm{s}}} = \sum_{k=1}^{K} \frac{\partial a_k}{\partial p_{\mathrm{s}}}.
\end{equation}
